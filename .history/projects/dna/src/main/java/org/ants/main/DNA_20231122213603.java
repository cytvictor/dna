...
public class DNA {
    ...
    public static void init(String configPath) throws IOException {
        ...
        //insert start time
        Date gen_start = new Date();
        ArrayList<String> fibUpdates = generator.generateFibUpdates(configUpdates);
        //insert end time
        Date gen_end = new Date();
        //compute and display time cost
        long gen_time = gen_end.getTime() - gen_start.getTime();
        System.out.println("FIB generation time: " + gen_time + "ms");
