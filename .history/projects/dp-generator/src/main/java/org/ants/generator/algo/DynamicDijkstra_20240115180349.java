...
public class DynamicDijkstra<TNode> {
  ...
  public static void main(String[] args) {
    ...
    //fattree04
    graph.addEdge("core0", "aggregation-12", new TWeight(1));
    graph.addEdge("core0", "aggregation-16", new TWeight(1));
    graph.addEdge("core0", "aggregation-8", new TWeight(1));
    graph.addEdge("core1", "aggregation-4", new TWeight(1));
