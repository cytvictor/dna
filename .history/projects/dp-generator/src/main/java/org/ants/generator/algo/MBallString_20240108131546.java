...
public class MBallString<TNode> {
  ...
  public static void main(String[] args) {
    ...
    Map<String, Path<String, TWeight>> shortestPaths = mballString.findShortestPaths(graph, "A",
    ...
    shortestPaths = mballString.findShortestPaths(graph, "A", new NumericalPath<>("A"), false);
