...
public class DynamicDijkstra<TNode> {
  ...
  public static void main(String[] args) {
    ...
    //fattree04
    graph.addEdge("core0", "aggregation12", new TWeight(1));
    graph.addEdge("core0", "aggregation16", new TWeight(1));
    graph.addEdge("core0", "aggregation8", new TWeight(1));
    graph.addEdge("core1", "aggregation13", new TWeight(1));
