...
public class Graph<TNode> {
  private Map <TNode, Map<TNode, TWeight>> adjacencyList;
  private Map <TNode, TNode> inNeighborList;
  private Map <TNode, TNode> outNeighborList;
  // private Map<TNode, List<Edge<TNode, TWeight>>> adjacencyList;
  // private Map<TNode, List<Edge<TNode, TWeight>>> inList;

  public Graph() {
    adjacencyList = new HashMap<>();
    inNeighborList = new HashMap<>();
    outNeighborList = new HashMap<>();
  }
